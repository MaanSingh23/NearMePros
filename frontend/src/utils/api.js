...
const API_URL = import.meta.env.VITE_API_URL || 
  (window.location.hostname === 'localhost' ? 'http://localhost:5000/api' : 'https://nearmepros.onrender.com/api');
...
if (API_URL.includes('localhost') && window.location.hostname !== 'localhost') {
  console.warn('[Near Me Pros] WARNING: Your app is still trying to connect to your local computer while in production. This will NOT work on mobile phones. Please ensure VITE_API_URL is set correctly in Vercel settings.');
}
